...
public static class EmailTemplates
{
            ...
            <body>
                <div class=""container"">
                    ...
                    <p class=""text"">
                        ...
                        <strong>Equipe tMoney</strong><br>
    ...
    public static string ChangeEmailTemplateMessageBody(string firstName, string changeEmailLink)
    {
        return $@"
            <!DOCTYPE html>
            <html lang=""pt-br"">
            ...
            <body>
                <div class=""container"">
                    ...
                    <p class=""text"">
                        Recebemos uma solicitação para alterar o e-mail da sua conta.<br>
                        Após a troca, você poderá usar o novo e-mail para fazer login e receber notificações, e o antigo será desvinculado da sua conta.
    ...
    public static string ChangeEmailTemplateSubject()
    {
        return $"Confirmação de alteração de e-mail - tMoney";
    }

    public static string ConfirmChangeEmailTemplateMessageBody(string firstName)
    {
        return $@"
            <!DOCTYPE html>
            <html lang=""pt-br"">
            ...
            <body>
                <div class=""container"">
                    ...
                    <p class=""text"">
                        O e-mail da sua conta foi alterado com sucesso!<br>
                        Após a troca, você poderá usar o novo e-mail para fazer login e receber notificações, e o antigo será desvinculado da sua conta.
                    </p>
    ...
    public static string ConfirmChangeEmailTemplateSubject()
    {
        return $"E-mail alterado com sucesso - tMoney";
    }
}

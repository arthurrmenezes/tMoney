...
public sealed class GetAllTransactionsByInvoiceIdServiceOutput
{
    ...
    private GetAllTransactionsByInvoiceIdServiceOutput(string id, string accountId, string cardId, string categoryId, string? installmentId, string? invoiceId, 
    ...
    public static GetAllTransactionsByInvoiceIdServiceOutput Factory(string id, string accountId, string cardId, string categoryId, string? installmentId, 

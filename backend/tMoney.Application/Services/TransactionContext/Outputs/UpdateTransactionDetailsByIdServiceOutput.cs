...
public sealed class UpdateTransactionDetailsByIdServiceOutput
{
    ...
    private UpdateTransactionDetailsByIdServiceOutput(string id, string accountId, string categoryId, string? installmentId, string title, string? description,
    ...
    public static UpdateTransactionDetailsByIdServiceOutput Factory(string id, string accountId, string categoryId, string? installmentId, string title, 

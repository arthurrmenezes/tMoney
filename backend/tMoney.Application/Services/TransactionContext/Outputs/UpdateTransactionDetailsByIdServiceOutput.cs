...
public sealed class UpdateTransactionDetailsByIdServiceOutput
{
    ...
    private UpdateTransactionDetailsByIdServiceOutput(string id, string accountId, string cardId, string categoryId, string? installmentId, string? invoiceId, 
    ...
    public static UpdateTransactionDetailsByIdServiceOutput Factory(string id, string accountId, string cardId, string categoryId, string? installmentId, 

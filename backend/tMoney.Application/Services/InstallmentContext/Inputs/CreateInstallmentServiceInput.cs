...
public sealed class CreateInstallmentServiceInput
{
    ...
    private CreateInstallmentServiceInput(IdValueObject accountId, int totalInstallments, decimal totalAmount, DateTime firstPaymentDate, 
    ...
    public static CreateInstallmentServiceInput Factory(IdValueObject accountId, int totalInstallments, decimal totalAmount, DateTime firstPaymentDate, 
        PaymentStatus status)
